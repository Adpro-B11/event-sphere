    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/api/events/*/reviews", "/api/events/*/reviews/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/events/*/reviews").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.PUT, "/api/events/*/reviews/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/events/*/reviews/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.GET, "/api/events/*/rating-summary").permitAll()
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/events/**").hasAnyRole("ORG   ANIZER", "ADMIN")
